...
shinnig = media.Movie("The Shining",
...
nightmare_on_elm_street = media.Movie("Nightmare on Elm Street",
...
movies = [gladiator,happy_gilmore,grown_ups,step_brothers,_300,smokey_and_the_bandit,shinnig,
          halloween,nightmare_on_elm_street]
